...
namespace BazeDeDate {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CLIENTDataTable : global::System.Data.TypedTableBase<CLIENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CLIENTRow AddCLIENTRow(int ID_CLIENT, string NUME, string PRENUME, string TELEFON) {
...
namespace BazeDeDate.DataSet1TableAdapters {
    ...
    public partial class CLIENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM \"ADMINPIZZA\".\"CLIENT\" WHERE ((\"ID_CLIENT\" = :Original_ID_CLIENT) AND " +
                "(\"NUME\" = :Original_NUME) AND (\"PRENUME\" = :Original_PRENUME) AND (\"TELEFON\" = :" +
                "Original_TELEFON))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"ADMINPIZZA\".\"CLIENT\" (\"ID_CLIENT\", \"NUME\", \"PRENUME\", \"TELEFON\") VAL" +
                "UES (:ID_CLIENT, :NUME, :PRENUME, :TELEFON)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""ADMINPIZZA"".""CLIENT"" SET ""ID_CLIENT"" = :ID_CLIENT, ""NUME"" = :NUME, ""PRENUME"" = :PRENUME, ""TELEFON"" = :TELEFON WHERE ((""ID_CLIENT"" = :Original_ID_CLIENT) AND (""NUME"" = :Original_NUME) AND (""PRENUME"" = :Original_PRENUME) AND (""TELEFON"" = :Original_TELEFON))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_CLIENT, NUME, PRENUME, TELEFON FROM ADMINPIZZA.CLIENT";
        ...
        public virtual int Delete(int Original_ID_CLIENT, string Original_NUME, string Original_PRENUME, string Original_TELEFON) {
        ...
        public virtual int Insert(int ID_CLIENT, string NUME, string PRENUME, string TELEFON) {
        ...
        public virtual int Update(int ID_CLIENT, string NUME, string PRENUME, string TELEFON, int Original_ID_CLIENT, string Original_NUME, string Original_PRENUME, string Original_TELEFON) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NUME, string PRENUME, string TELEFON, int Original_ID_CLIENT, string Original_NUME, string Original_PRENUME, string Original_TELEFON) {
            return this.Update(Original_ID_CLIENT, NUME, PRENUME, TELEFON, Original_ID_CLIENT, Original_NUME, Original_PRENUME, Original_TELEFON);
        }
    }
